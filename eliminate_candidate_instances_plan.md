...
#### File Menu (22 commands) - ✓ COMPLETE
- ✓ Print configuration (filemenu.py:2009)
- ✓ Print correlations (filemenu.py:2036)
- ✓ Print evaluations (filemenu.py:2067)
- ✓ Print grouped data (filemenu.py:2094)
- ✓ Print individuals (filemenu.py:2121)
- ✓ Print sample design (filemenu.py:2148)
- ✓ Print sample repetitions (filemenu.py:2175)
- ✓ Print sample solutions (filemenu.py:2202)
- ✓ Print scores (filemenu.py:2232)
- ✓ Print similarities (filemenu.py:2262)
- ✓ Print target (filemenu.py:2293)
- ✓ Save configuration (filemenu.py:2332)
- ✓ Save grouped data (filemenu.py:2387)
- ✓ Save correlations (filemenu.py:2442)
- ✓ Save individuals (filemenu.py:2502)
- ✓ Save sample design (filemenu.py:2562)
- ✓ Save sample repetitions (filemenu.py:2658)
- ✓ Save sample solutions (filemenu.py:2749)
- ✓ Save scores (filemenu.py:2853)
- ✓ Save similarities (filemenu.py:3110)
