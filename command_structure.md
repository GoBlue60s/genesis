...
## 9. Check for consistency with existing features
...
## 10. Perform the requested action inherent in the command
1. optional
2. such as  inter_point_distances, rank_when_similarities_match_X, Rivalry

## 11. Print on Record tab
...
## 13. Create title for table widget depending on how __init__ sets title
