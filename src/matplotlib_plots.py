...
# --------------------------------------------------------------------------
	...
	def _plot_base_using_matplotlib(
			self,
			base_groups_to_show: str) -> plt.Figure:
		...
		base_people_points = configuration_active.\
			_populate_base_groups_to_show(base_groups_to_show)
		matplotlib_plotter.\
			_fill_base_regions_in_matplotlib_plot(ax, base_people_points)
...
# --------------------------------------------------------------------------
	...
	def request_battleground_plot_for_plot_and_gallery_tabs_using_matplotlib(
		...
		director.common.set_axis_extremes_based_on_coordinates(
			point_coords)
	...
	def _plot_battleground_using_matplotlib(
			self,
			battleground_groups_to_show: str) -> plt.Figure:
		...
		fig, ax = \
			matplotlib_common.begin_matplotlib_plot_with_title("Battleground")
		ax = matplotlib_common.set_aspect_and_grid_in_matplotlib_plot(ax)
		...
		battleground_people_points = configuration_active.\
			_populate_battleground_groups_to_show(battleground_groups_to_show)
	...
	def _fill_battleground_regions_in_matplotlib_plot(
		...
		ax.fill(
			battleground_segment._x, battleground_segment._y,
	...
	def plot_compare_using_matplotlib(self, target: pd.DataFrame) \
			-> plt.Figure:
		...
		for each_point in range_points:
			...
			ax.text(
				point_coords.iloc[each_point, 0],
				point_coords.iloc[each_point, 1], "A")
			ax.text(
				target.iloc[each_point, 0],
				target.iloc[each_point, 1], "T")
			ax.plot(
				[point_coords.iloc[each_point, 0],
				target.iloc[each_point, 0]],
				[point_coords.iloc[each_point, 1],
...
# --------------------------------------------------------------------------
	...
	def _plot_contest_using_matplotlib(self) -> plt.Figure:
		...
		core_a = plt.Circle((
			...
			radius=rivalry.connector.length * .2,
			fill=False, hatch="X")
		core_b = plt.Circle((
	...
	def _plot_convertible_using_matplotlib(
			self, convertible_groups_to_show: str) -> plt.Figure:
		...
		fig, ax = \
			matplotlib_common.begin_matplotlib_plot_with_title("Convertible")
		ax = matplotlib_common.set_aspect_and_grid_in_matplotlib_plot(ax)
...
# --------------------------------------------------------------------------
	...
	def _plot_core_using_matplotlib(
		self,
		core_groups_to_show: str) -> plt.Figure:
		...
		matplotlib_plotter.\
			_determine_circles_defining_core_regions_using_matplotlib()
		
		core_people_points = configuration_active.\
			_populate_core_groups_to_show(core_groups_to_show)
		matplotlib_plotter.\
			_fill_core_regions_in_matplotlib_plot(ax, core_people_points)
...
# --------------------------------------------------------------------------
	...
	def _determine_circles_defining_core_regions_using_matplotlib(
		...
		core_a = plt.Circle((
			...
			radius=core_radius, color=core_left._fill)
		core_b = plt.Circle((
			core_right_center.x, core_right_center.y),
			radius=core_radius, color=core_right._fill)
...
# --------------------------------------------------------------------------
	...
	def _fill_core_regions_in_matplotlib_plot(
		...
		ax.scatter(
			...
			color=score_color, s=point_size)
	...
	def _plot_cutoff_using_matplotlib(
			self,
			value_type: str) -> plt.Figure:
	...
	def plot_evaluation_means_using_matplotlib(self) -> plt.Figure:
		...
		fig, ax = matplotlib_common.\
			begin_matplotlib_plot_with_title("Average Evaluations")
		x = avg_eval.index
		y = avg_eval
		plt.barh(x, y)
	...
	def _plot_first_using_matplotlib(self,
			first_dim_groups_to_show: str) -> plt.Figure:
...
# -----------------------------------------------------------------**-------
	...
	def plot_a_heatmap_dist_using_matplotlib(self) -> plt.Figure:
		...
		point_labels = configuration_active.point_labels
		distances_as_square = \
			configuration_active.distances_as_square
...
# --------------------------------------------------------------------------
	...
	def \
	request_heatmap_rank_diff_plot_for_plot_and_gallery_tabs_using_matplotlib(
			self) -> None:
...
# ------------------------------------------------------------------------
	...
	def \
	request_heatmap_ranked_dist_plot_for_plot_and_gallery_tabs_using_matplotlib(
			self) -> None:
	...
	def \
	request_heatmap_ranked_simi_plot_for_plot_and_gallery_tabs_using_matplotlib(
			self) -> None:
...
# --------------------------------------------------------------------------
	...
	def plot_individuals_using_matplotlib(self) -> plt.Figure:
		...
		# fig, ax = plt.subplots()
		fig, ax = self._director.matplotlib_common.\
			begin_matplotlib_plot_with_title(None)
		ax = self._director.matplotlib_common.\
			set_aspect_and_grid_in_matplotlib_plot(ax)
		#
		# ax.set_aspect("equal")
	...
	def _plot_joint_using_matplotlib(self) -> plt.Figure:
		...
		fig, ax = matplotlib_common.\
			begin_matplotlib_plot_with_title("Candidates and Voters")
		ax = matplotlib_common.set_aspect_and_grid_in_matplotlib_plot(ax)
		matplotlib_common.add_axes_labels_to_matplotlib_plot(ax)
		matplotlib_common.set_ranges_for_matplotlib_plot(ax)
	...
	def request_likely_plot_for_plot_and_gallery_tabs_using_matplotlib(
		...
		likely_groups_to_show = \
			director.current_command.likely_groups_to_show
	...
	def _plot_likely_using_matplotlib(
			self, likely_groups_to_show: str) -> plt.Figure:
	...
	def _fill_likely_regions_in_matplotlib_plot(self,
			ax: plt.Axes,
		...
		ax.fill(
			...
			likely_right._fill)
		ax.fill(
			likely_left.vertices.x,
			likely_left.vertices.y,
			likely_left._fill)
	...
	def request_scree_plot_for_plot_and_gallery_tabs_using_matplotlib(
		...
		fig, ax = \
			matplotlib_common.begin_matplotlib_plot_with_title("Scree Plot")
	...
	def _plot_second_using_matplotlib(self,
		second_dim_groups_to_show: str) -> plt.Figure:
		...
		matplotlib_plotter.\
			_fill_second_dim_regions_in_matplotlib_plot(
	...
	def plot_target_using_matplotlib(self) -> plt.Figure:
		...
		fig, ax = \
			matplotlib_common.begin_matplotlib_plot_with_title(None)
		ax = matplotlib_common.set_aspect_and_grid_in_matplotlib_plot(ax)
...
# --------------------------------------------------------------------------
	...
	def plot_uncertainty_using_matplotlib(self) -> plt.Figure:
		...
		repetitions_rotated = \
			director.uncertainty_active.repetitions_rotated

		fig, ax = matplotlib_common.\
			begin_matplotlib_plot_with_title("Uncertainty")
		ax = matplotlib_common.set_aspect_and_grid_in_matplotlib_plot(ax)
		ax.set_xlabel(dim_names[hor_dim])
		ax.set_ylabel(dim_names[vert_dim])
		matplotlib_common.set_ranges_for_matplotlib_plot(ax)
...
# --------------------------------------------------------------------------
	...
	def _plot_vectors_using_matplotlib(self) -> plt.Figure:
		...
		for each_point in configuration_active.range_points:
			...
			ax.arrow(
					...
					point_coords.iloc[each_point, vert_dim],
					color="black",
					head_width=self._director.matplotlib_common.\
						vector_head_width,
	...
	def _plot_custom_using_matplotlib(self) -> plt.Figure:
		...
		custom_vert_max = 1.0
		ax.axis(
			[custom_hor_min, custom_hor_max, custom_vert_min,
				custom_vert_max])
