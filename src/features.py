...
class ConfigurationFeature:
	def __init__(self, director: Status) -> None:  # xxxxxxxxxx
		...
		self.commonalities: pd.DataFrame = pd.DataFrame()
		self.factor_variance: pd.DataFrame = pd.DataFrame()
		self.uniquenesses: pd.DataFrame = pd.DataFrame()
		self.loadings: pd.DataFrame = pd.DataFrame()
		self.factor_analysis_df: pd.DataFrame = pd.DataFrame()
		self.x_new: pd.DataFrame = pd.DataFrame()
		self.scores: pd.DataFrame = pd.DataFrame()
		self.covar: pd.DataFrame = pd.DataFrame()
		self.pca_covar: pd.DataFrame = pd.DataFrame()
		self.fa: Any = None
		self.transformer_mean: Any = None
		self.transformer_noise_variance: Any = None
