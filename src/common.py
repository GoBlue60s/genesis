...
# ------------------------------------------------------------------------
	...
	def get_command_parameters(
		self, command_name: str, **kwargs: object
	) -> dict[str, Any]:
	...
	def _handle_file_dialog(
		...
		directory = getter_info.get("directory")
	...
	def _handle_chose_option_dialog(
		...
		options_builder = getter_info.get("options_builder")
		if options_builder:
	...
	def _get_items_from_source(self, getter_info: dict[str, Any]) -> list:
		...
		Returns:
			List of items
		"""
		items_source = getter_info.get("items_source")
		if items_source:
	...
	def _get_default_values(
		...
		"""
		default_values = getter_info.get("default_values")

		# Resolve dynamic defaults if defaults_source is specified
		defaults_source = getter_info.get("defaults_source")
		if defaults_source:
	...
	def _build_dynamic_options(
		...
		if builder_method:
			options_source = getter_info.get("options_source")
			if options_source:
