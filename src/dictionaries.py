...
# ----------------------------------------------------------------------------
# Dictionary: command_dependencies_dict
...
command_dependencies_dict = MappingProxyType({
	"About": (),
	"Alike": ("configuration", "similarities"),
	"Base": ("configuration", "reference_points"),
	"Battleground": ("configuration", "reference_points"),
	"Center": ("configuration",),
	"Cluster": ("configuration",),
	"Compare": ("configuration", "target"),
	"Configuration": (),
	"Contest": ("configuration", "reference_points"),
	"Convertible": ("configuration", "reference_points"),
	"Core supporters": ("configuration", "reference_points"),
	"Correlations": (),
	"Create": (),
	"Deactivate": (),
	...
	"Factor analysis machine learning": ("evaluations",),
	"First dimension": ("configuration", "reference_points"),
	"Grouped data": (),
	"Help": (),
	"History": (),
	"Individuals": (),
	"Invert": ("configuration",),
	"Joint": ("configuration", "scores"),
	"Likely supporters": ("configuration", "reference_points"),
	"Line of sight": ("evaluations",),
	"MDS": ("similarities",),
	"Move": ("configuration",),
	"New grouped data": (),
	"Open sample design": (),
	"Open sample repetitions": ("sample_design",),
	"Open sample solutions": (),
	"Open scores": (),
	"Open script": (),
	"Paired": ("configuration", "similarities"),
	"Principal components": ("evaluations",),
	"Print configuration": ("configuration",),
	"Print correlations": ("correlations",),
	"Print evaluations": ("evaluations",),
	"Print grouped data": ("grouped_data",),
	"Print individuals": ("individual_data",),
	"Print sample design": ("sample_design",),
	"Print sample repetitions": ("sample_repetitions",),
	"Print sample solutions": ("sample_solutions",),
	"Print scores": ("scores",),
	...
	"Sample designer": ("evaluations",),
	"Sample repetitions": ("evaluations", "sample_design"),
	"Save configuration": ("configuration",),
	"Save correlations": ("correlations",),
	"Save grouped data": ("grouped_data",),
	"Save individuals": ("individual_data",),
	"Save sample design": ("sample_design",),
	"Save sample repetitions": ("sample_repetitions",),
	"Save sample solutions": ("sample_solutions",),
	"Save scores": ("scores",),
	...
	"Terse": (),
	"Tester": (),
	"Uncertainty": ("evaluations", "target"),
	"Undo": (),
	"Varimax": ("configuration",),
	"Vectors": ("configuration",),
	"Verbose": (),
	"View configuration": ("configuration",),
	"View correlations": ("correlations",),
	"View custom": ("configuration",),
	"View distances": ("configuration", "distances"),
	"View evaluations": ("evaluations",),
	"View grouped data": ("grouped_data",),
	"View individuals": ("individual_data",),
	"View point uncertainty": ("sample_solutions",),
	"View sample design": ("sample_design",),
	"View sample repetitions": ("sample_repetitions",),
	"View sample solutions": ("sample_solutions",),
	"View scores": ("scores",),
	"View script": (),
	"View similarities": ("similarities",),
	"View spatial uncertainty": ("sample_solutions",),
	"View target": ("target",),
})
