...
from PySide6.QtGui import (
	QAction, QBrush, QFont, QIcon, QPalette, QPixmap
)
from PySide6.QtWidgets import (
	QFileDialog, QLabel, QMainWindow,
	QMenu, QPushButton,
	QScrollArea, QSizePolicy, QSpacerItem, QStatusBar,
	QTableWidget, QTabWidget, QTextEdit, QToolBar,
	QToolButton,
	QVBoxLayout, QWidget
)
# Typing imports
...
from table_builder import (
	BuildOutputForGUI, BasicTableWidget, SquareTableWidget,
...
# --------------------------------------------------------------------------
	...
	def set_column_and_row_headers(
			self, table_widget: QTableWidget, column_header: list[str],
			row_header: list[str]) -> None:
	...
	def resize_and_set_table_size(
		gui_output_as_widget: QTableWidget, fudge: int) -> None:
	...
	def disable_mouse_events(
			self,
			graphics_layout_widget: pg.GraphicsLayoutWidget) -> None:
		# Loop over each row
		if hasattr(graphics_layout_widget, 'ci'):
			...
			print("At bottom of disable_mouse_events, graphics_layout_widget does not have attribute 'ci'")
	...
	def create_file_menu(self) -> dict:
		...
		return {
			"New": {
				...
				"items": {
					"Configuration": ["spaces_filenew.png",
						"new_configuration", "Create a new configuration"],
					"Grouped data": ["spaces_grouped_data_icon.jpg",
						"new_grouped_data", "Create new grouped data"],
				}
			},
			"Open": {
				"icon": None,
				"items": {
					"Configuration": ["spaces_fileopen.png",
						"open_configuration",
						"Open an existing configuration"],
					"Target": ["spaces_target_icon.jpg", "open_target",
						"Open an existing target"],
					"Grouped data": ["spaces_grouped_data_icon.jpg",
						"open_grouped_data", "Open existing grouped data"],
					"Similarities": {
					...
					"Correlations": ["spaces_correlations_icon.jpg",
						"open_correlations",
						"Open existing correlations matrix"],
					"Evaluations": ["spaces_evaluations_icon.jpg",
						"open_evaluations", "Open existing evaluations file"],
					"Individuals": ["spaces_individuals_icon.jpg",
						"open_individuals", "Open existing individuals file"],
					"Scores": ["spaces_scores_icon.jpg", "open_scores",
						"Open existing scores file"],
					"Sample": {
						"icon": "spaces_sample_icon.jpg",
						"items": {
							"Design": [None, "open_sample_design",
								"Open existing sample design file"],
							"Repetitions": [None, "open_sample_repetitions",
								"Open existing sample repetitions file"],
							"Solutions": [None, "open_sample_solutions",
			...
			"Print": {
				...
				"items": {
					"Configuration": [None, "print_configuration",
						"Print active configuration"],
					"Target": [None, "print_target", "Print active target"],
					"Grouped data": [None, "print_grouped_data",
						"Print active grouped data"],
					"Correlations": [None, "print_correlations",
						"Print active correlations"],
					"Similarities": [None, "print_similarities",
						"Print active similarities"],
					"Evaluations": [None, "print_evaluations",
						"Print active evaluations"],
					"Individuals": [None, "print_individuals",
						"Print active individuals"],
					"Scores": [None, "print_scores", "Print active scores"],
					"Sample": {
						"icon": "spaces_sample_icon.jpg",
						"items": {
							"Design": [None, "print_sample_design",
								"Print active sample design"],
							"Repetitions": [None, "print_sample_repetitions",
								"Print active sample repetitions"],
							"Solutions": [None, "print_sample_solutions",
...
# --------------------------------------------------------------------------
	...
	def create_view_menu(self) -> dict:
		...
		return {
			"Configuration": ["outer_space_icon.png", "view_configuration",
				"View active configuration"],
			"Target": ["spaces_view_target_icon.jfif", "view_target",
				"View active target"],
			"Grouped data": ["spaces_grouped_data_icon.jpg", "view_grouped",
				"View active grouped data"],
			"Similarities": ["spaces_black_icon.jpg", "view_similarities",
				"View active similarities"],
			"Correlations": ["spaces_r_red_icon.jpg", "view_correlations",
				"View active correlations"],
			"Distances": ["spaces_green_icon.png", "view_distances",
				"View active distances"],
			"Evaluations": ["spaces_evaluations_icon.jpg", "view_evaluations",
				"View active evaluations"],
			"Individuals": ["spaces_individuals_icon.jpg", "view_individuals",
				"View active individuals"],
			"Scores": ["spaces_scores_icon.jpg", "view_scores",
				"View active scores"],
			"History": ["spaces_history_icon.jpg", "history",
				"View history of commands"],
			"Sample": {
				"icon": "spaces_sample_icon.jpg",
				"items": {
					"Design": [None, "view_sample_design",
						"View active sample design"],
					"Repetitions": [None, "view_sample_repetitions",
						"View active sample repetitions"],
					"Solutions": [None, "view_sample_solutions",
			...
			"Spatial uncertainty": {
				...
				"items": {
					"Lines": [None, "view_spatial_uncertainty_lines",
						"View spatial uncertainty as lines"],
					"Boxes": [None, "view_spatial_uncertainty_boxes",
						"View spatial uncertainty as boxes"],
					"Ellipses": [None, "view_spatial_uncertainty_ellipses",
			...
			"Point uncertainty": {
				"icon": "spaces_uncertainty_icon.png",
				"items": {
					"Lines": [None, "view_point_uncertainty_lines",
						"View point uncertainty as lines"],
					"Boxes": [None, "view_point_uncertainty_boxes",
						"View point uncertainty as boxes"],
					"Ellipses": [None, "view_point_uncertainty_ellipses",
						"View point uncertainty as ellipses"],
				}
			},
			"Custom": ["spaces_custom_icon.png", "view_custom",
				"View custom display"]
		}
...
# --------------------------------------------------------------------------
	...
	def create_transform_menu(self) -> dict:
		...
		return {
			"Center": ["spaces_center_icon.jpg", "center",
				"Center the active configuration"],
			"Move": ["spaces_move_icon.png", "move",
				"Move points in the active configuration"],
			"Invert": ["spaces_invert_icon.jpg", "invert",
				"Invert dimensions in the active configuration"],
			"Rescale": ["spaces_rescale_icon.jpg", "rescale",
				"Rescale dimensions in the active configuration"],
			"Rotate": ["spaces_rotate_icon.jpg", "rotate",
				"Rotate the active configuration"],
			"Compare": ["spaces_compare_icon.jpg", "compare",
...
# --------------------------------------------------------------------------
	...
	def create_associations_menu(self) -> dict:
		...
		return {
			"Correlations": ["spaces_correlations_icon.jpg", "correlations",
				"Compute correlations"],
			"Similarities": ["spaces_similarities_icon.jpg", "similarities",
				"Compute similarities"],
			"Line of sight": ["spaces_los_icon.jpg", "line_of_sight",
				"Compute Line of sight coefficients"],
			"Paired": ["spaces_paired_icon.jpg", "paired",
				"Compare pairs of points"],
			"Alike": ["spaces_alike_icon.jpg", "alike",
			...
			"Distances": ["spaces_distances_icon.jpg", "distances",
				"Compute distances in active configuration"],
			"Ranks": {
				"icon": "spaces_associations_ranks_icon.jpg",
				"items": {
					"Ranks of distances": [None, "ranks_distances",
						"Rank distances"],
					"Ranks of similarities": [None, "ranks_similarities",
						"Rank similarities"],
					"Difference of ranks": [None, "ranks_differences",
						"Difference of ranks"]
				}
			},
			"Scree diagram": ["spaces_scree_icon.jpg", "scree",
				"Create a scree diagram"],
			"Shepard diagram": {
				"icon": "spaces_shepard_icon.jpg",
				"items": {
					"Similarities on x-axis": [None,
						"shepard_similarities_on_x",
						"Display similarities on x-axis in Shepard diagram"],
					"Similarities on y-axis": [None,
						"shepard_similarities_on_y",
						"Display similarities on y-axis in Shepard diagram"],
				}
			},
			"Stress contribution": ["spaces_stress_icon.jpg",
				"stress_contribution",
...
# --------------------------------------------------------------------------
	...
	def create_model_menu(self) -> dict:
		...
		return {
			"Principal Components": ["spaces_pca_icon.jpg", "principal",
				"Perform Principal Components Analysis"],
			"Factor Analysis": ["spaces_factor_analysis_icon.jpg",
			...
			"Multi-Dimensional Scaling": {
				...
				"items": {
					"Use non-metric estimation": [None, "mds_non_metric",
					"Perform non-metric Multi-Dimensional Scaling"],
					"Use metric estimation": [None, "mds_metric",
					"Perform metric Multi-Dimensional Scaling"]
				}
			},
			"Vectors": ["spaces_vectors_icon.jfif", "vectors",
				"Display active configuration as vectors"],
			"Directions": ["spaces_directions_icon.jfif", "directions",
				"Display active configuration as directions"],
			"Uncertainty": ["spaces_uncertainty_icon.png", "uncertainty",
...
# --------------------------------------------------------------------------
	...
	def create_respondents_menu(self) -> dict:
		...
		return {
			"Evaluations": ["spaces_evaluations_icon.jpg", "evaluations",
				"Evaluations by respondents"],
			"Sample": {
				"icon": "spaces_sample_icon.jpg",
				"items": {
					"Design samples": [None, "sample_designer",
						"Design samples"],
					"Generate repetitions": [None, "sample_repetitions",
						"Generate repetitions"],
				}
			},
			"Score individuals": ["spaces_scores_icon.jpg",
						"score_individuals",
				"Score individuals"],
			"Joint": ["spaces_joint_icon.jpg", "joint",
				"Display individuals and active configuration"],
			"Reference points": ["spaces_reference_icon.jpg",
				"reference_points", "Set reference points"],
			"Contest": ["spaces_contest_icon.jpg", "contest",
				"Display contest between rivals"],
			"Segments": ["spaces_segments_icon.jpg", "segments",
				"Describe segments in contest"],
			"Core": {
				"icon": "spaces_core_icon.jpg",
				"items": {
					"Spatially defined regions": [None, "core_regions",
						"Display core supporter regions"],
					"Left core supporters": [None, "core_left",
						"Display core supporters of left rival"],
					"Right core supporters": [None, "core_right",
						"Display core supporters of right rival"],
					"Both core supporters": [None, "core_both",
						"Display core supporters of both rivals"],
					"Neither core supporters": [None, "core_neither",
			...
			"Base supporters": {
				...
				"items": {
					"Spatially defined regions": [None, "base_regions",
						"Display regions defining base of rivals"],
					"Left base supporters": [None, "base_left",
						"Display base supporters of left rival"],
					"Right base supporters": [None, "base_right",
						"Display base supporters of right rival"],
					"Both base supporters": [None, "base_both",
						"Display base supporters of both rivals"],
					"Neither base supporters": [None, "base_neither",
			...
			"Likely supporters": {
				...
				"items": {
					"Spatially defined regions": [None, "likely_regions",
						"Display regions defining likely supporters"
							" of rivals"],
					"Likely left supporters": [None, "likely_left",
						"Display likely supporters of left rival"],
					"Likely right supporters": [None, "likely_right",
						"Display likely supporters of right rival"],
					"Both likely supporters": [None, "likely_both",
			...
			"Battleground": {
				...
				"items": {
					"Spatially defined regions": [None, "battleground_regions",
						"Display battleground regions"],
					"Battleground": [None, "battleground_segment",
						"Display battleground segment"],
					"Settled": [None, "battleground_settled",
			...
			"Convertible": {
				...
				"items": {
					"Spatially defined regions": [None, "convertible_regions",
						"Display convertible regions"],
					"Convertible to the left": [None, "convertible_left",
						"Display individuals convertible to the left rival"],
					"Convertible to the right": [None, "convertible_right",
						"Display individuals convertible to the right rival"],
					"Both": [None, "convertible_both",
						"Display individuals convertible to both rivals"],
					"Settled": [None, "convertible_settled",
						"Display settled segment"]
				}
			},
			"Focused on first dimension": {
				...
				"items": {
					"Spatially defined regions": [None, "first_regions",
						"Display regions defined by first dimension"],
					"Left focused": [None, "first_left",
						"Display individuals on the left of mean on"
						" first dimension"],
					"Right focused": [None, "first_right",
			...
			"Focused on second dimension": {
				...
				"items": {
					"Spatially defined regions": [None, "second_regions",
						"Display regions defined by second dimension"],
					"Upper focused": [None, "second_upper",
						"Display individuals "
						"above mean on second dimension"],
					"Lower focused": [None, "second_lower",
						"Display individuals "
						"below mean on second dimension"]
				}
			}
		}
...
# --------------------------------------------------------------------------
	...
	def create_help_menu(self) -> dict:
		...
		return {
			"Help Content": ["spaces_help_icon.jpg", "help_content",
				"Help content"],
			"Status": ["spaces_status_icon.jpg", "status", "Display status"],
			"Verbose": ["spaces_verbosity_icon.jfif", "verbose",
...
# --------------------------------------------------------------------------
	...
	def add_submenus(self, menu: QMenu, submenus: dict) -> None:
		...
		valid_keys = {"icon", "command", "enabled", "shortcut", "items",
				"tooltip"}
		...
		for submenu_name, action_or_submenu in submenus.items():
			if isinstance(action_or_submenu, dict):
				...
				if "command" in action_or_submenu:  # Menu item with properties
					...
					if action_or_submenu.get("icon"):
						action = QAction(QIcon(
							str(Path(self.basedir) / icon_directory /
				...
				if icon:
					action = QAction(QIcon(
						str(Path(self.basedir) / icon_directory / icon)),
						submenu_name, self)
				else:
					action = QAction(submenu_name, self)
				if tooltip:
				...
				menu.addAction(action)
				if next_command in["deactivate", "open_grouped_data",
					"open_correlations", "print_target", "print_grouped_data",
					"print_similarities", "line_of_sight", "contest",
					"joint"]:
					menu.addSeparator()
...
# -------------------------------------------------------------------------
	...
	#     thus there are fewer match cases than menu items
		...
		self.commands = (
			"About", "Alike", "Base", "Battleground", "Center", "Cluster",
			"Compare", "Configuration", "Contest", "Convertible",
			"Core supporters", "Correlations", "Create", "Deactivate",
			"Directions", "Distances",
			"Evaluations", "Exit", "Factor classic", "Factor machine learning",
			"First dimension", "Grouped", "Help", "History", "Individuals",
			"Invert", "Joint", "Likely supporters", "Line of sight", "MDS",
			"Move", "New grouped data", "Open sample design",
			"Open sample repetitions", "Open scores",
			"Paired", "Principal Components",
			"Print configuration", "Print correlations", "Print evaluations",
			"Print grouped data", "Print sample design",
			"Print sample repetitions",
			"Print scores", "Print similarities",
			"Print target", "Ranks differences",
			"Ranks distances", "Ranks similarities", "Redo",
			"Reference points", "Rescale", "Rotate",
			"Sample designer", "Sample repetitions",
			"Save configuration", "Save correlations", "Save individuals",
			"Save sample design", "Save sample repetitions",
			"Save scores", "Save similarities", "Save target",
			"Score individuals",
			"Scree", "Second dimension", "Segments",
			"Settings - display sizing",
			"Settings - layout options", "Settings - plane",
			"Settings - plot settings",
			"Settings - presentation layer Matplotlib",
			"Settings - presentation layer PyQtGraph", "Settings - segment",
			"Settings - vector sizing", "Shepard", "Similarities", "Status",
			"Stress contribution", "Target", "Terse", "Tester", "Uncertainty",
			"Undo", "Varimax", "Vectors", "Verbose", "View configuration",
			"View correlations",
			"View custom", "View distances", "View evaluations",
			"View grouped data", "View point uncertainty",
			"View sample design",
			"View sample repetitions",
			"View scores", "View similarities", "View spatial uncertainty",
			"View target"
		)
	...
	def create_tool_bar(self) -> None:
		...
		button_dict = {
			"new": ("spaces_filenew.png", "new_configuration",
				"Create new configuration"),
			"open": ("spaces_fileopen.png", "open_configuration",
				"Open existing configuration"),
			"save": ("spaces_filesave.png", "save_configuration",
				"Save current configuration"),
			"undo": ("spaces_undo_icon.jpg", "undo", "Undo last action"),
			"redo": ("spaces_redo_icon.jpg", "redo",
			...
			"shepard": ("spaces_shepard_icon.jpg",
				"shepard_similarities_on_x", "Show Shepard diagram"),
			"mds": ("spaces_mds_icon.jpg", "mds",
				"Perform Multi-Dimensional Scaling"),
			"factor_analysis": ("spaces_factor_analysis_icon.jpg",
				"factor_analysis", "Perform Factor Analysis"),
			"principal_components": ("spaces_pca_icon.jpg",
				"principal", "Perform Principal Components Analysis"),
			"reference_points": ("spaces_reference_icon.jpg",
				"reference_points", "Set reference points"),
			"contest": ("spaces_contest_icon.jpg", "contest", "Show contest"),
			"segments": ("spaces_segments_icon.jpg", "segments",
				"Show segments"),
			"core": ("spaces_core_icon.jpg", "core_regions",
				"Show core supporter regions"),
			"base": ("spaces_base_icon.jpg", "base_regions",
				"Show base supporter regions"),
			"likely": ("spaces_likely_icon.jpg", "likely_regions",
				"Show likely supporter regions"),
			"battleground": ("spaces_battleground_icon.jpg",
				"battleground_regions", "Show battleground regions"),
			"convertible": ("spaces_convertible_icon.jpg",
				"convertible_regions", "Show convertible regions"),
			"first": ("spaces_first_dim_icon.jpg", "first_regions",
				"Show first dimension regions"),
			"second": ("spaces_second_dim_icon.jpg", "second_regions",
		...
		for key, (icon, _next_command, _) in button_dict.items():
			...
			button_action.triggered.connect(
				self.create_lambda(_next_command))
	...
	def get_file_name_and_handle_nonexistent_file_names(self,
			file_caption: str,
			file_filter: str) -> str:
...
# ------------------------------------------------------------------------
	...
	def get_file_name_to_store_file_initialize_variables(
		self) -> None:
	...
	def get_file_name_to_store_file(self, dialog_caption:str,
		dialog_filter: str) -> str:
	...
	def include_explanation_when_verbosity_last_set_to_verbose(self) -> bool:
		...
		if len(self.commands_used) > 0 and self.commands_used[0] == "Verbose" \
...
class BuildTrafficDict:
	def __init__(
		...
		from associationsmenu import ( # noqa: PLC0415
			AlikeCommand, ClusterCommand, DistancesCommand,
			LineOfSightCommand, PairedCommand,
			RanksDifferencesCommand,
			RanksDistancesCommand, RanksSimilaritiesCommand,
			ScreeCommand, ShepardCommand, StressContributionCommand
		)
		...
		from helpmenu import ( # noqa: PLC0415
			AboutCommand, HelpCommand, StatusCommand,
			TerseCommand, VerboseCommand
		)
		from modelmenu import ( # noqa: PLC0415
			DirectionsCommand, FactorAnalysisCommand,
		...
		self.traffic_dict = {
			...
			"open_similarities_dissimilarities":
				(SimilaritiesCommand, "dissimilarities"),
			"open_similarities_similarities":
				(SimilaritiesCommand, "similarities"),
			...
			"settings_presentation_matplotlib":
				(SettingsPresentationLayerCommand, "Matplotlib"),
			"settings_presentation_pyqtgraph":
				(SettingsPresentationLayerCommand, "PyQtGraph"),
			...
			"factor_analysis_machine_learning":
				(FactorAnalysisMachineLearningCommand, None),
			"mds":  (MDSCommand, None),
...
class BuildWidgetDict:
	def __init__(self, parent: Status) -> None:
		...
		self.widget_dict = {
			...
			"Individuals": [IndividualsCommand, "shared",
				lambda: parent.statistics.display_table("individuals")],
			"Invert": [InvertCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Joint": [JointCommand, "shared", parent.display_a_line],
			"Likely supporters": [LikelySupportersCommand, "shared",
				lambda: parent.statistics.display_table("likely")],
			"Line of sight": [LineOfSightCommand, "shared",
				lambda: parent.squares.display_table("similarities")],
			"MDS": [MDSCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Move": [MoveCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"New grouped data": [NewGroupedDataCommand, "shared",
				lambda: parent.tables.display_table("grouped_data")],
			"Open correlations": [CorrelationsCommand, "shared",
				lambda: parent.squares.display_table("correlations")],
			"Open scores": [OpenScoresCommand, "shared",
				lambda: parent.statistics.display_table("scores")],
			"Open sample design": [OpenSampleDesignCommand, "shared",
				lambda: parent.statistics.display_table("sample_design")],
			"Open sample repetitions": [OpenSampleRepetitionsCommand, "shared",
				lambda: parent.statistics.display_table("sample_repetitions")],
			"Open sample solutions":
				[OpenSampleSolutionsCommand, "unique", None],
			"Paired": [PairedCommand, "unique", None],
			"Principal components": [PrincipalComponentsCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Print configuration": [PrintConfigurationCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Print correlations": [PrintCorrelationsCommand, "shared",
				lambda: parent.squares.display_table("correlations")],
			"Print evaluations": [PrintEvaluationsCommand, "shared",
				lambda: parent.statistics.display_table("evaluations")],
			"Print grouped data": [PrintGroupedDataCommand, "shared",
				lambda: parent.tables.display_table("grouped_data")],
			"Print individuals": [PrintIndividualsCommand, "shared",
				lambda: parent.statistics.display_table("individuals")],
			"Print sample design": [PrintSampleDesignCommand, "shared",
				lambda: parent.statistics.display_table("sample_design")],
			"Print sample repetitions": [PrintSampleRepetitionsCommand,
				"shared",
				lambda: parent.statistics.display_table("sample_repetitions")],
			"Print similarities": [PrintSimilaritiesCommand, "shared",
				lambda: parent.squares.display_table("similarities")],
			"Print scores": [PrintScoresCommand, "shared",
				lambda: parent.statistics.display_table("scores")],
			"Print target": [PrintTargetCommand, "shared",
				lambda: parent.tables.display_table("target")],
			"Ranks distances": [RanksDistancesCommand, "shared",
				lambda: parent.squares.display_table("ranked_distances")],
			"Ranks similarities": [RanksSimilaritiesCommand, "shared",
				lambda: parent.squares.display_table("ranked_similarities")],
			"Ranks differences": [RanksDifferencesCommand, "shared",
				lambda: parent.squares.display_table("ranked_differences")],
			"Redo": [RedoCommand, "shared", parent.display_coming_soon],
			"Reference points": [ReferencePointsCommand, "shared",
				parent.display_a_line],
			"Rescale": [RescaleCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Rotate": [RotateCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Sample designer": [SampleDesignerCommand, "shared",
				lambda: parent.statistics.display_table("sample_design")],
			"Sample repetitions": [SampleRepetitionsCommand, "shared",
				lambda: parent.statistics.display_table("sample_repetitions")],
			"Save configuration": [SaveConfigurationCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Save target": [SaveTargetCommand, "shared",
				lambda: parent.tables.display_table("target")],
			"Save correlations": [SaveCorrelationsCommand, "shared",
				lambda: parent.squares.display_table("correlations")],
			"Save similarities": [SaveSimilaritiesCommand, "shared",
				lambda: parent.squares.display_table("similarities")],
			"Save individuals": [SaveIndividualsCommand, "shared",
				lambda: parent.statistics.display_table("individuals")],
			"Save scores": [SaveScoresCommand, "shared",
				lambda: parent.statistics.display_table("scores")],
			"Save sample design": [SaveSampleDesignCommand, "shared",
				lambda: parent.statistics.display_table("sample_design")],
			"Save sample repetitions":
				[SaveSampleRepetitionsCommand,  "shared",
				lambda: parent.statistics.display_table("sample_repetitions")],
			"Save sample solutions":
				[SaveSampleSolutionsCommand, "shared", None],
			"Score individuals": [ScoreIndividualsCommand, "shared",
				lambda: parent.statistics.display_table("scores")],
			"Scree": [ScreeCommand, "shared",
				lambda: parent.statistics.display_table("scree")],
			"Second dimension": [SecondDimensionCommand, "shared",
				lambda: parent.statistics.display_table("second")],
			"Segments": [SegmentsCommand, "shared",
			...
			"Settings - segment sizing": [SettingsSegmentCommand,
				"unique", None],
			"Settings - display sizing": [SettingsDisplayCommand,
				"unique", None],
			"Settings - vector sizing": [SettingsVectorSizeCommand, "unique",
				None],
			"Settings - presentation layer":
				[SettingsPresentationLayerCommand, "shared",
				parent.display_a_line],
			"Settings - layout options": [SettingsLayoutCommand,
								"unique", None],
			"Shepard": [ShepardCommand, "shared",
				lambda: parent.squares.display_table("shepard")],
			"Similarities": [SimilaritiesCommand, "shared",
				lambda: parent.squares.display_table("similarities")],
			"Status": [StatusCommand, "unique", None],
			"Stress contribution": [StressContributionCommand, "shared",
				lambda: parent.statistics.display_table(
					"stress_contribution")],
			"Target": [TargetCommand, "shared",
				lambda: parent.tables.display_table("target")],
			"Terse": [TerseCommand, "shared", parent.display_a_line],
			"Uncertainty": [UncertaintyCommand, "shared",
				lambda: parent.statistics.display_table("uncertainty")],
			"Undo": [UndoCommand, "shared", parent.display_coming_soon],
			"Varimax": [VarimaxCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Vectors": [VectorsCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"Verbose": [VerboseCommand, "shared", parent.display_a_line],
			"View configuration": [ViewConfigurationCommand, "shared",
				lambda: parent.tables.display_table("configuration")],
			"View correlations": [ViewCorrelationsCommand, "shared",
				lambda: parent.squares.display_table("correlations")],
			"View custom": [ViewCustomCommand, "unique", None],
			"View distances": [ViewDistancesCommand, "shared",
				lambda: parent.squares.display_table("distances")],
			"View evaluations": [ViewEvaluationsCommand, "shared",
				lambda: parent.statistics.display_table("evaluations")],
			"View grouped data": [ViewGroupedDataCommand, "shared",
				lambda: parent.tables.display_table("grouped_data")],
			"View individuals": [ViewIndividualsCommand, "shared",
				lambda: parent.statistics.display_table("individuals")],
			"View scores": [ViewScoresCommand, "shared",
				lambda: parent.statistics.display_table("scores")],
			"View sample design": [ViewSampleDesignCommand, "shared",
				lambda: parent.statistics.display_table("sample_design")],
			"View sample repetitions": [ViewSampleRepetitionsCommand, "shared",
				lambda: parent.statistics.display_table("sample_repetitions")],
			"View sample solutions": [ViewSampleSolutionsCommand, "shared",
